...
def retrieve_extraneous_inputs(cgpms, v_to_c):
    ...
    return list(itertools.chain.from_iterable(extraneous))
...
def retrieve_ancestors(cgpms, q):
    ...
    def ancestors(v):
        ...
        return list(itertools.chain.from_iterable(parent_ancestors)) + parents
    return ancestors(q)
...
def retrieve_descendents(cgpms, q):
    ...
    def descendents(v):
        ...
        return list(itertools.chain.from_iterable(children_descendents)) + children
